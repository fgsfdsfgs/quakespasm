...
cvar_t	max_edicts = {"max_edicts", "2048", CVAR_NONE}; //johnfitz //ericw -- changed from 2048 to 8192, removed CVAR_ARCHIVE
...
// config.cfg cvars
	...
	{
		f = fopen (va("%s" PATHSEP "config.cfg", com_gamedir), "w");
		if (!f)
		{
